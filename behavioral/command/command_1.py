...
class RemoteController:
    ...
    def button_status(self, name: str) -> str:
        if name in self._buttons:
            return f'Button {self._buttons.get('first_button')}'

        return f'Button not exists.'
...
if __name__ == '__main__':
    ...
    bedroom_light_orange = LightChangeColorCommand(bedroom_light, 'Orange')
    bedroom_light_yellow = LightChangeColorCommand(bedroom_light, 'Yellow')
    bedroom_light_pink = LightChangeColorCommand(bedroom_light, 'Pink')
    bedroom_light_white = LightChangeColorCommand(bedroom_light, 'White')
    ...
    remote.button_add_command('fourth_button', bedroom_light_yellow)
    remote.button_add_command('fifth_button', bedroom_light_pink)
    remote.button_add_command('sixth_button', bedroom_light_white)
    ...
    remote.button_pressed('fifth_button')
    remote.button_pressed('sixth_button')
